...
// Secure portal authentication for healthcare professionals
// ============================================================
    ...
    <div class="login-wrapper">
      <div class="login-card">
        <div class="login-header">
          ...
          <div class="arch-badge">Onion Architecture (Step 3)</div>
        ...
        <form [formGroup]="loginForm" (ngSubmit)="onSubmit()" class="login-form">
          <div class="form-group">
            ...
            <input
              ...
              placeholder="e.g. admin or dr.jenkins"
...
export class LoginComponent {
  ...
  private authService = inject(AuthServicePort);
